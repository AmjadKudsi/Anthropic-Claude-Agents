// run the provided code that uses an orchestrator agent with agents-as-tools
// The orchestrator will delegate three independent store cost calculations to calculator agents, but these agent calls will execute one after another instead of concurrently
